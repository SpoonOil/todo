...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var json_cycle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! json-cycle */ "./node_modules/json-cycle/cycle.js");
/* harmony import */ var json_cycle__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(json_cycle__WEBPACK_IMPORTED_MODULE_0__);
...
class Overhead {
    ...
    saveToLocal() {
        localStorage.setItem("allTodoLists", JSON.stringify(json_cycle__WEBPACK_IMPORTED_MODULE_0__.decycle(this.listsArray)))

    }
}


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Overhead);
...
class DOMHandler {
  ...
  renderAllLists() {
    ...
    addListBtn.addEventListener("click", () => {
      const newList = new _tasks_js__WEBPACK_IMPORTED_MODULE_0__.TaskList("New List " + this.allLists.length, "Description");
  ...
  renderTaskList() {
    ...
    for (let task of this.currentList.getTasks()) {
      ...
      if (task.dueDate != "No Deadline") {
        deadlineBody.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(task.dueDate, "MM/dd/yyyy");
...
class Task {
  ...
  constructor(name, description, taskList, priority, dueDate) {
    ...
    this.createDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(Date.now(), "MM/dd/yyyy")
...
/* harmony import */ var _printDOM_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./printDOM.js */ "./src/printDOM.js");
/* harmony import */ var _controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controller.js */ "./src/controller.js");
/* harmony import */ var json_cycle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! json-cycle */ "./node_modules/json-cycle/cycle.js");
/* harmony import */ var json_cycle__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(json_cycle__WEBPACK_IMPORTED_MODULE_4__);





const test = new _tasks_js__WEBPACK_IMPORTED_MODULE_0__.TaskList('Tasks', 'Description');
...
if (localStorage.allTodoLists[0] != undefined) {
    ...
    taskLists = json_cycle__WEBPACK_IMPORTED_MODULE_4__.retrocycle(JSON.parse(localStorage.allTodoLists))
    _tasks_js__WEBPACK_IMPORTED_MODULE_0__.TaskList.addFunctionsToJSONarray(taskLists)
    console.log(taskLists)
}

const dom = new _printDOM_js__WEBPACK_IMPORTED_MODULE_2__["default"](document.getElementById('task-lists-display'), document.querySelector('.task-display-list'), taskLists[0], taskLists);
...
const overhead = new _controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](document.getElementById('add-task-display'), _tasks_js__WEBPACK_IMPORTED_MODULE_0__.TaskList, taskLists, taskLists[0], dom)
